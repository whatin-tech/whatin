import{c as e,g as t,h as n,i as r,p as i,r as a,s as o}from"./firebase-config-Dhjpa17D.js";/* empty css                   */import{t as s}from"./nav-auth-cgdUL366.js";var c=t((()=>{e(),document.addEventListener(`DOMContentLoaded`,async()=>{let e=document.getElementById(`loadingState`),t=document.getElementById(`emptyState`),s=document.getElementById(`placementGrid`);try{let c=i(a(r,`resources`),n(`category`,`==`,`placement`)),l=await o(c);if(e.style.display=`none`,l.empty){t.style.display=`block`;return}let u=l.docs.map(e=>e.data());u.sort((e,t)=>(t.createdAt?.seconds||0)-(e.createdAt?.seconds||0)),s.innerHTML=u.map(e=>`
